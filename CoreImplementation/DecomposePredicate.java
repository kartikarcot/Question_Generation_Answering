...
public class DecomposePredicate {
	 ...
	 */
	String ruleForSelectingSentencesWithPredicates = "ROOT < (S=mainclause < (VP=predphrase [ < (/VB.?/=tensedverb !< is|was|were|am|are|has|have|had|do|does|did) | < /VB.?/=tensedverb !< VP ]))";
	 ...
	 */
//	public Tree decomposePredicate(Tree sentenceTree) {
...
//			TsurgeonPattern p;
//			if (!lemma.equals("be")) {
//				// replace predphrase with (MAINVP PLACEHOLDER)
